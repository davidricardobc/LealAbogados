...
export const metadata: Metadata = {
  title: "Contacto",
  description: "Contacta a Leal Abogados para agendar una consulta juridica o solicitar soporte legal empresarial.",
  alternates: {
    canonical: "/contacto",
  },
};
  ...
  return (
    <>
      <PageHero
        ...
        description="Comparte el contexto inicial del caso y el equipo podra orientar el siguiente paso: consulta, revision documental, accion legal o acompanamiento empresarial."
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.75fr_1.25fr]">
          <div>
            <SectionHeader
              ...
              description="Estos campos centralizan telefono, correo, ciudad y canales definitivos para mantener la comunicacion consistente antes de publicar."
            />
            <div className="mt-8 space-y-4 border border-ink/10 p-6">
              <p className="text-sm text-muted">Telefono</p>
